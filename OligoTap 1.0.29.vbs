...
Dim objFolder, objItem, objShell, fragfilepath, fragsfilepaths(), filevar(), files(), filenames(),filepaths(), tempfile(), filelines(),  mgf_check(), begin_ion_indices(), end_ion_indices(), oligofragments(), sequences(), oligo(), oligo_1(), filevar_m,oligoname(), tempfile_report, oligoprecursors()          
...
For Each oligo in oligos              
    oligos(c)=MyoligoFile.ReadLine              
    oligo_2=Split(oligos(c),"=")              
    oligo_1(c)=oligo_2(0)              
    oligoname(c)=oligo_2(1)              
    'MsgBox oligoname(c)              
    fragsfilepaths(c)=fragfilepath              
    c=c+1              
Next  
MyoligoFile.Close
Set MyoligoFile=Nothing  
						...
						Elseif charge_comparison="x" then
							...
							For Each signal In oligofragments 
								...
								if oligofragments(c10)<CDbl((a1_mz(c9)+(1*H)))+CDbl((a1_mz(c9)+(1*H)))*ppmrange2 and oligofragments(c10)>CDbl((a1_mz(c9)+(1*H)))-CDbl((a1_mz(c9)+(1*H)))*ppmrange2 and d1<c12 then                      
									...
									lightest_cluster_check_counter=0
									light_logic=true
									For Each mono_signal In oligofragments
										
										if oligofragments(lightest_cluster_check_counter)-small_dalton<CDbl((a1_mz(c9)+(1*H))) and oligofragments(lightest_cluster_check_counter)-big_dalton>CDbl((a1_mz(c9)+(1*H))) then
											light_logic=false
										else
										End if
										lightest_cluster_check_counter=lightest_cluster_check_counter+1
									Next
								...
								if oligofragments(c10)<CDbl((ab_mz(c9)+(1*H)))+CDbl((ab_mz(c9)+(1*H)))*ppmrange2 and oligofragments(c10)>CDbl((ab_mz(c9)+(1*H)))-CDbl((ab_mz(c9)+(1*H)))*ppmrange2 and d1<c12 then                  
									...
									for each mono_signal in oligofragments
										...
										if oligofragments(lightest_cluster_check_counter)-small_dalton<CDbl((ab_mz(c9)+(1*H))) and oligofragments(lightest_cluster_check_counter)-big_dalton>CDbl((ab_mz(c9)+(1*H))) then
											light_logic=false
										else 
										End If
										lightest_cluster_check_counter=lightest_cluster_check_counter+1
								...
								if oligofragments(c10)<CDbl((b_mz(c9)+(1*H)))+CDbl((b_mz(c9)+(1*H)))*ppmrange2 and oligofragments(c10)>CDbl((b_mz(c9)+(1*H)))-CDbl((b_mz(c9)+(1*H)))*ppmrange2 and d1<c12 then                   
									...
									for each mono_signal in oligofragments
										...
										if oligofragments(lightest_cluster_check_counter)-small_dalton<CDbl((b_mz(c9)+(1*H))) and oligofragments(lightest_cluster_check_counter)-big_dalton>CDbl((b_mz(c9)+(1*H))) then
											light_logic=false
										else
										End If
										lightest_cluster_check_counter=lightest_cluster_check_counter+1
								...
								if oligofragments(c10)<CDbl((c_mz(c9)+(1*H)))+CDbl((c_mz(c9)+(1*H)))*ppmrange2 and oligofragments(c10)>CDbl((c_mz(c9)+(1*H)))-CDbl((c_mz(c9)+(1*H)))*ppmrange2 and d1<c12 then                     
									...
									for each mono_signal in oligofragments
										...
										if oligofragments(lightest_cluster_check_counter)-small_dalton<CDbl((c_mz(c9)+(1*H))) and oligofragments(lightest_cluster_check_counter)-big_dalton>CDbl((c_mz(c9)+(1*H))) then
											light_logic=false
										else
										End if
										lightest_cluster_check_counter=lightest_cluster_check_counter+1
								...
								if oligofragments(c10)<CDbl((d_mz(c9)+(1*H)))+CDbl((d_mz(c9)+(1*H)))*ppmrange2 and oligofragments(c10)>CDbl((d_mz(c9)+(1*H)))-CDbl((d_mz(c9)+(1*H)))*ppmrange2 and d1<c12 then     
									...
									light_logic=true
									for each mono_signal in oligofragments
										if oligofragments(lightest_cluster_check_counter)-small_dalton<CDbl((d_mz(c9)+(1*H))) and oligofragments(lightest_cluster_check_counter)-big_dalton>CDbl((d_mz(c9)+(1*H))) then	
											light_logic=false
										else
										End If
										lightest_cluster_check_counter=lightest_cluster_check_counter+1
								...
								if oligofragments(c10)<CDbl((w_mz(c9)+(1*H)))+CDbl((w_mz(c9)+(1*H)))*ppmrange2 and oligofragments(c10)>CDbl((w_mz(c9)+(1*H)))-CDbl((w_mz(c9)+(1*H)))*ppmrange2 and d1<=c12 then                 
									...
									light_logic=true
									for each mono_signal in oligofragments
										if oligofragments(lightest_cluster_check_counter)-small_dalton<CDbl((w_mz(c9)+(1*H))) and oligofragments(lightest_cluster_check_counter)-big_dalton>CDbl((w_mz(c9)+(1*H))) then 
											light_logic=false
										else
								...
								if oligofragments(c10)<CDbl((x_mz(c9)+(1*H)))+CDbl((x_mz(c9)+(1*H)))*ppmrange2 and oligofragments(c10)>CDbl((x_mz(c9)+(1*H)))-CDbl((x_mz(c9)+(1*H)))*ppmrange2 and d1<=c12 then                    
									...
									light_logic=true
									for each mono_signal in oligofragments
										if oligofragments(lightest_cluster_check_counter)-small_dalton<CDbl((x_mz(c9)+(1*H))) and oligofragments(lightest_cluster_check_counter)-big_dalton>CDbl((x_mz(c9)+(1*H))) then 
											light_logic=false
										else
										End If
										lightest_cluster_check_counter=lightest_cluster_check_counter+1
								...
								if oligofragments(c10)<CDbl((y_mz(c9)+(1*H)))+CDbl((y_mz(c9)+(1*H)))*ppmrange2 and oligofragments(c10)>CDbl((y_mz(c9)+(1*H)))-CDbl((y_mz(c9)+(1*H)))*ppmrange2 and d1<=c12 then              
									...
									light_logic=true
									for each mono_signal in oligofragments
										if oligofragments(lightest_cluster_check_counter)-small_dalton<CDbl((y_mz(c9)+(1*H))) and oligofragments(lightest_cluster_check_counter)-big_dalton>CDbl((y_mz(c9)+(1*H))) then 
											light_logic=false
										Else
										End if
										lightest_cluster_check_counter=lightest_cluster_check_counter+1
								...
								if oligofragments(c10)<CDbl((z_mz(c9)+(1*H)))+CDbl((z_mz(c9)+(1*H)))*ppmrange2 and oligofragments(c10)>CDbl((z_mz(c9)+(1*H)))-CDbl((z_mz(c9)+(1*H)))*ppmrange2 and d1<=c12 then            
									...
									light_logic=true
									for each mono_signal in oligofragments
										if oligofragments(lightest_cluster_check_counter)-small_dalton<CDbl((z_mz(c9)+(1*H))) and oligofragments(lightest_cluster_check_counter)-big_dalton>CDbl((z_mz(c9)+(1*H))) then 
											light_logic=false
										Else
										End If
										lightest_cluster_check_counter=lightest_cluster_check_counter+1
